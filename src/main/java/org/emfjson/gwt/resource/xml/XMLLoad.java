...
import org.emfjson.gwt.resource.XMLResource;
...
public class XMLLoad
{
  ...
  /* (non-Javadoc)
   * @see org.eclipse.emf.ecore.xmi.XMLLoad#load(org.eclipse.emf.ecore.xmi.XMLResource, com.google.gwt.xml.client.Node, java.util.Map)
   */
